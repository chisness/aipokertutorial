...
## Regret
Regret we previously touched on in @sec-regret. 
...
*See [@johanson_cfr_quora_2015] for more detail*.
...
Here's an example from [@neller2013cfrtutorial]. Assume that the regret counters start at 0 for each action. 
